...
<body>
    ...
    <!-- Navigation -->
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background:#ff6866">
        <div class="container" >
    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="fill" style="background-image:url('images/feedback4_1.jpg');"></div>
            ...
            <div class="item">
                <div class="fill" style="background-image:url('images/feedback2_1.jpg');"></div>
                <div class="carousel-caption">
			 ...
			 <!object width="550" height ="40000">
                <div class="fill" style="background-image:url('images/feedback5_1.jpg');"></div>
                <div class="carousel-caption">
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<div class="col-sm-10" style="margin-top:60px;margin-bottom:80px">
				...
				Student Feedback system for College.<br>
...
Before we can look into the php code, you need to create a database called "feed" with two tables in it..one as student and another one as take
	...
	<div class="navbar-fixed-bottom nav navbar-inverse text-center" style="padding:15px;height:40px; background:#ff6866">
		<span style="color:#FFFFFF">Developed By Adarsh Jaiswal, Hari Vilas Panjwani,Muhilan K</span>
	</div>
    <!-- jQuery -->
