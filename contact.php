...
?>
       ...
       <div class="row">
			...
			<div class="col-md-4" style="margin-top:30px">
                ...
                <p>
                    VIT University Chennai Campus,<br>Vandalur Kelambakam Road,<br>Chennai - 600 127,Tamil Nadu,India<br>
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: +91 44 3993 1555</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">E</abbr>: <a href="mailto:name@example.com">vit@vit.university.in</a>
                </p>
